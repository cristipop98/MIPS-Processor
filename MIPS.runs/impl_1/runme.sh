...
HD_PWD='C:/Users/Cristi/MIPS/MIPS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_if.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_if.tcl -notrace
