...
HD_PWD='C:/Users/Cristi/MIPS/MIPS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_if.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_if.tcl
